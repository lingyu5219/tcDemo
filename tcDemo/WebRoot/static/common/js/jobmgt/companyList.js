$(function () {
	var tableOption = {
		//ajax查询数据的http请求url
		queryUrl : basePath + "/job/queryCompanyList",
		//ajax删除数据的http请求url
		delUrl : basePath + "/job/delCompany",
		//ajax增加数据的http请求url
		addUrl : basePath + "/job/addCompany",
		//Table对象
		table : $('#dataListTable'),
		//查询表单Form对象
		form : $("#queryForm"),
    ...
    $("#btn-add").on("click", function () {
    	var jcAdd = $.dialog({
    		title: '增加公司',
    	    content: 'url:' + basePath + '/forward?page=job/companyAdd',
