$(function () {
	var tableOption = {
		//ajax查询数据的http请求url
		queryUrl : basePath + "edumgt/queryMajorList",
		//ajax删除数据的http请求url
		delUrl : basePath + "edumgt/delMajor",
		//增加页面
		addPageUrl : basePath + 'forward?page=edumgt/majorAdd',
		//ajax增加数据的http请求url
		addUrl : basePath + "edumgt/addMajor",
		//修改页面
		updatePageUrl : basePath + 'forward?page=edumgt/majorModify',
		//ajax修改数据的http请求url
		updateUrl : basePath + "edumgt/updateMajor",
		//查看页面
		detailPageUrl : basePath + 'forward?page=edumgt/majorDetail',
		//Table对象
		table : $('#dataListTable'),
		//查询表单Form对象
		form : $("#queryForm"),
    ...
    tableOption.table.on("click",".delRow",function() {
        ...
        var params = {majorId:item.majorId};
        //调用删除方法，向服务器发送请求
