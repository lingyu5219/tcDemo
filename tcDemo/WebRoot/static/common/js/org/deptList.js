$(function () {
	var tableOption = {
		//ajax查询数据的http请求url
		queryUrl : basePath + "/dept/queryDeptList",
		//ajax增加数据的http请求url
		addUrl : basePath + "/dept/addDept",
		//ajax删除数据的http请求url
		delUrl : basePath + "/dept/deleteDept",
		//Table对象
		table : $('#dataListTable'),
		//查询表单Form对象
		form : $("#queryForm"),
  ...
  //增加
    $("#btn-add").on("click", function () {
    	var jcAdd = $.dialog({
    		title: '增加部门',
    	    content: 'url:' + basePath + '/forward?page=org/deptAdd',
    	    	...
    	    	this.$content.find("button.btn-save").click(function(){
    	    		...
    	    		$.ajax({
    	                ...
    	                success: function(data){
    	                	if(data.deptName != null && data.deptName != "" && data.deptName != "undefined"){
