...
LeoUpload.prototype.createFileItem = function(file){
	...
	var fileName = $("<span class=\"upload_info_text\" title=\"" + file.name + "\">" + file.name + "&nbsp;</span>");
	var fileSize = $("<span class=\"upload_info_text\">" + Math.ceil(file.size / 1024) + "KB </span>");
	var fileProgressNum = $("<span class=\"leoFileProgressNum\">0</span>");

	fileName.append(fileSize).append(fileProgressNum);
