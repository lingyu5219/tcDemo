...
<head>
	...
	<script src="${basePath}/static/common/js/jobmgt/companyList.js"></script>
						...
						<div class="box">
							<div class="box-header with-border">
								<form id="queryForm" class="form-horizontal no-padding" role="form" action="${basePath}/user/queryUserList" method="post">
					                ...
					                <div class="col-md-4">
										<div class="form-group">
						                    <label class="col-md-3 control-label" for="coName">用户名</label>
						                    <div class="col-md-9">
						                    	<input type="text" class="form-control" id="coName" name="coName" placeholder="请输入公司名">
						                    </div>
						                </div>
					                </div>
