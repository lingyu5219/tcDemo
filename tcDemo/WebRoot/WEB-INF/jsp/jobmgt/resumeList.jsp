...
<head>
	...
	<script src="${basePath}/static/common/js/jobmgt/resumeList.js"></script>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header with-border">
								<form id="queryForm" class="form-horizontal no-padding" role="form" action="${basePath}/resume/queryResumeList" method="post">
					                <div class="col-md-6">
					                ...
					                <div class="col-md-4">
										<div class="form-group">
						                    <label class="col-md-3 control-label" for="resumeDescribe">简历描述</label>
						                    <div class="col-md-9">
						                    	<input type="text" class="form-control" id="resumeDescribe" name="resumeDescribe" placeholder="请输入描述">
						                    </div>
						                </div>
					                </div>
