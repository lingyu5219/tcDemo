           ...
           <div class="col-sm-6">
            	<div class="form-group">
                   <label class="col-md-3 control-label">教室名称</label>
                  	<div class="col-md-9">
			    	<input type="text" class="form-control" id="roomName" name="roomName" placeholder="教室名称" />
				</div>
			</div>
           </div>
           <div class="col-sm-6">
            	<div class="form-group">
                   <label class="col-md-3 control-label">区域ID</label>
                  	<div class="col-md-9">
			    	<input type="text" class="form-control" id="centerId" name="centerId" placeholder="区域ID" />
				</div>
			</div>
           </div>
          </div>
           ...
           <div class="col-sm-6">
            	<div class="form-group">
                   <label class="col-md-3 control-label">操作人</label>
                  	<div class="col-md-9">
			    	<input type="text" class="form-control" id="createBy" name="createBy" placeholder="操作人" />
				</div>
			</div>
           </div>
           <div class="col-sm-6">
