...
<script src="${basePath}static/common/js/edumgt/batchList.js"></script>
</head>
                        ...
                        <div class="box-header with-header">
                            <form id="queryForm" class="form-horizontal no-padding" method="post">
                                <div class="row">
					                <div class="col-md-4">
										<div class="form-group">
						                    <label class="col-md-3 control-label" for="batchName">班级</label>
						                    <div class="col-md-9">
						                    	<input type="text" class="form-control" id="batchName" name="batchName" placeholder="请输入班级名">
						                    </div>
						                </div>
					                </div>
					                <div class="col-md-8">
                                ...
                                <div class="row">
				                    <div class="col-md-4">
				                		<div class="form-group">
					                		<label class="col-md-3 control-label" for="yearId">学年</label>
						                    <div class="col-md-9">
				                    ...
				                    <div class="col-md-4">
				                		<div class="form-group">
				                			<label class="col-md-3 control-label" for="majorId">专业方向</label>
						                    <div class="col-md-9">
