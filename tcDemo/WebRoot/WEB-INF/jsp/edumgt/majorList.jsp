...
<head>
	...
	<script src="${basePath}static/common/js/edumgt/majorList.js"></script>
</head>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header with-border">
								<form id="queryForm" class="form-horizontal no-padding" role="form" action="${basePath}/major/queryMajorList" method="post">
					                <div class="col-md-5">
					                ...
					                <div class="col-md-5">
										<div class="form-group">
						                    <label class="col-md-3 control-label" for="majorName">专业名称</label>
						                    <div class="col-md-9">
