	            ...
	            <div class="col-sm-6">
	             	<div class="form-group">
	                    <label class="col-md-3 control-label">职位名</label>
	                   	<div class="col-md-9">
					    	<input type="text" class="form-control" id="name" name="positionName" placeholder="请输入职位名" />
						</div>
					</div>
	            </div>
	            <div class="col-sm-6">
	            	<div class="col-md-9 col-md-offset-3">
	            		...
	            		<button style="display:none" type="button" class="btn btn-flat btn-block btn-primary btn-save">保存</button>
	            	</div>
	            </div>
            </div>
</form>
